console.log('\
      options - add to script exec to active option:\n\
        - adding save and close btn to qiuck task panel: add_custom_quick_task_btn = true;\n\
        - sec option\
');
  ...
  $(".main-grid-row-body td:nth-child(3)").append('<span class="trackBtn">track</span><span class="actionBtn close">close</span>');
    ...
    $(".trackBtn").click(function(){
      ...
      if($(this).hasClass("stopTrack")){
        ...
        }else if($(this).closest('tr[data-group-id]').length){
